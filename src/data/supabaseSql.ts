...
CREATE TABLE IF NOT EXISTS public.app_settings (
  ...
  site_content JSONB NOT NULL DEFAULT '{
    ...
    "youtubeUrl": "https://youtube.com/@easyacss",
...
CREATE POLICY "Public insert/update app_settings" ON public.app_settings FOR ALL USING (true) WITH CHECK (true);

-- 2. Policies for app_configs
DROP POLICY IF EXISTS "Public read app_configs" ON public.app_configs;
CREATE POLICY "Public read app_configs" ON public.app_configs FOR SELECT USING (true);
DROP POLICY IF EXISTS "Public insert/update app_configs" ON public.app_configs;
CREATE POLICY "Public insert/update app_configs" ON public.app_configs FOR ALL USING (true) WITH CHECK (true);

-- 3. Policies for game_accounts
DROP POLICY IF EXISTS "Public read game_accounts" ON public.game_accounts;
CREATE POLICY "Public read game_accounts" ON public.game_accounts FOR SELECT USING (true);
DROP POLICY IF EXISTS "Public insert/update game_accounts" ON public.game_accounts;
CREATE POLICY "Public insert/update game_accounts" ON public.game_accounts FOR ALL USING (true) WITH CHECK (true);

-- 4. Policies for member_users
DROP POLICY IF EXISTS "Public read member_users" ON public.member_users;
CREATE POLICY "Public read member_users" ON public.member_users FOR SELECT USING (true);
DROP POLICY IF EXISTS "Public insert/update member_users" ON public.member_users;
CREATE POLICY "Public insert/update member_users" ON public.member_users FOR ALL USING (true) WITH CHECK (true);

-- 5. Policies for claim_activities
DROP POLICY IF EXISTS "Public read claim_activities" ON public.claim_activities;
CREATE POLICY "Public read claim_activities" ON public.claim_activities FOR SELECT USING (true);
DROP POLICY IF EXISTS "Public insert/update claim_activities" ON public.claim_activities;
CREATE POLICY "Public insert/update claim_activities" ON public.claim_activities FOR ALL USING (true) WITH CHECK (true);
